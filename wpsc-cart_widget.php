<?php if(wpsc_cart_item_count() > 0): //cart icon appears only once there are items in it ?>
	...
	<div class="cart-widget">
		...
		<a target="_parent" href="<?php echo get_option('shopping_cart_url'); ?>" title="Checkout" class="gocheckout"><span id="theme-checkout-count"><?php echo wpsc_cart_item_count(); ?></span></a>
		...
		<a target="_parent" href="<?php echo get_option('shopping_cart_url'); ?>" title="Checkout" class="gocheckout"><span id="theme-checkout-total"><?php echo $explode[0]; ?></span></a>
