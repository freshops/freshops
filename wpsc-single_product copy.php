...
<?php
		...
		<div class="sixcol first"><?php the_post_thumbnail( 'portrait-300' ); ?> </div>
						<div class="sixcol last">
							...
							if(get_field('hgoa_description')){ ?>
								<dl><dt>Hop Growers of America Description</dt>
...
<div class="sixcol last">						<?php if ( wpsc_the_product_thumbnail() ) : ?>
						...
						<?php else: ?>
									...
									<img class="no-image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="No Image" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo get_bloginfo('template_directory');?>/wpsc-images/noimage.png"/>
									</a>
						<?php endif; ?>
					</div><!--close imagecol-->
