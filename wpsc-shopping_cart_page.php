...
echo __('There is nothing in your cart yet. ', 'wpsc') . '<a href=' . esc_url( get_option( 'product_list_url', '' ) ) . ">" . __('Please visit our shop.', 'wpsc') . '</a>';
return;
endif;
?>
...
<em>Please allow 7-10 days for your order to arrive.</em>
   ...
   <table class='wpsc_checkout_table table-1'>
   	...
   	<?php if(wpsc_checkout_form_is_header() == true){
   		$i++;
               ...
               <span id="shippingsameasbillingmessage"><?php _e('', 'wpsc'); ?></span>
           </td>
       </tr>
   <?php endif;
