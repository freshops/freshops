...
// Call kerplop scripts only on pages using list view: Hop categories and subcategories, and Rhizome categories and subcategories.
function do_kerplop() {
	wp_enqueue_script(
		'do-kerplop',
		get_template_directory_uri() . '/library/js/do_kerplop.js',
		array('jquery')
	);
}
